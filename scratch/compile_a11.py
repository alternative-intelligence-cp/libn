...
os.makedirs('/home/randy/Workspace/META/LIBN/audits/a11', exist_ok=True)

out_file = '/home/randy/Workspace/META/LIBN/audits/a11/compilation.md'
with open(out_file, 'w') as f_out:
    f_out.write('# libn A11 Source Compilation\n\n')
...
print("A11 Compilation successful.")
