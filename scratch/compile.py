...
os.makedirs('/home/randy/Workspace/META/LIBN/audits/a8', exist_ok=True)

out_file = '/home/randy/Workspace/META/LIBN/audits/a8/compilation.md'
with open(out_file, 'w') as f_out:
    f_out.write('# libn A8 Source Compilation\n\n')
