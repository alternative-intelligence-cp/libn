...
os.makedirs('/home/randy/Workspace/META/LIBN/audits/a10', exist_ok=True)

out_file = '/home/randy/Workspace/META/LIBN/audits/a10/compilation.md'
with open(out_file, 'w') as f_out:
    f_out.write('# libn A10 Source Compilation\n\n')
...
print("A10 Compilation successful.")
