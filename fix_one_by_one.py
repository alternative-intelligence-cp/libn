...
for clean in clean_lines:
    ...
    # Find which file has this error
    # We'll just look at all files, check line number.
    # If the line looks like it matches the error, we schedule a fix.
    ...
    for file in files:
        ...
        if line <= len(flines):
            ...
            if new_val != orig:
                ...
                # Check if we already scheduled a fix for this line
